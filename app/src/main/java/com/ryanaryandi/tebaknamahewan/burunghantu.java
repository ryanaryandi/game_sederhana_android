...
public class burunghantu extends AppCompatActivity {
    ImageView gambar;
    Button cek,imah;
    EditText jawab;
    String jawaban;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_burunghantu);
...
//mengambil gambar dari database
        Glide.with(burunghantu.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fburung%20hantu.jpg?alt=media&token=1802ac6e-707a-4df1-aa61-17c63b966e16")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("burung hantu")) {
                    ...
                    Intent pindah = new Intent(burunghantu.this, kuda.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(burunghantu.this, depan.class);
