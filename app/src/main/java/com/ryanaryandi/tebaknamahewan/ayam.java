...
//mengambil gambar dari database
        Glide.with(ayam.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fayam.jpg?alt=media&token=cc1464c2-6cf3-4f39-be0f-5c75706639e4")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("ayam")) {
                    ...
                    Intent pindah = new Intent(ayam.this, tikus.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(ayam.this, depan.class);
