...
public class labalaba extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_labalaba);
...
//mengambil gambar dari database
        Glide.with(labalaba.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Flaba%20laba.jpg?alt=media&token=ffc9a3f7-b2e6-43af-afd0-5b1c820f7629")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("laba laba")) {
                    ...
                    Intent pindah = new Intent(labalaba.this, kerbau.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(labalaba.this, depan.class);
