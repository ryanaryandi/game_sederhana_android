...
//mengambil gambar dari database
        Glide.with(badak.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fbadak.jpg?alt=media&token=df94c79a-752c-429d-9daf-db9dac9e1518")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("badak")) {
                    ...
                    Intent pindah = new Intent(badak.this, siput.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(badak.this, depan.class);
