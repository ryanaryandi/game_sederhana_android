...
//mengambil gambar dari database
        Glide.with(kuda.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fkuda.jpg?alt=media&token=df658765-2b6e-4a85-bc0c-b23234211638")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("kuda")) {
                    ...
                    Intent pindah = new Intent(kuda.this, kurakura.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(kuda.this, depan.class);
