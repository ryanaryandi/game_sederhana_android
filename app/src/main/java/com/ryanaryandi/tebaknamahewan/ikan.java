...
//mengambil gambar dari database
        Glide.with(ikan.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fikan.jpg?alt=media&token=b67ccb79-ee86-4d67-a98f-deeacd39c2a5")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("ikan")) {
                    ...
                    Intent pindah = new Intent(ikan.this, kecoa.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(ikan.this, depan.class);
