...
public class buaya extends AppCompatActivity {
    ImageView gambar;
    Button cek,imah;
    EditText jawab;
    String jawaban;
...
//mengambil gambar dari database
        Glide.with(buaya.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fbuaya.jpg?alt=media&token=f478acc8-30ad-42b4-84c9-d21ac8e0c173")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("buaya")) {
                    ...
                    Intent pindah = new Intent(buaya.this, udang.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(buaya.this, depan.class);
