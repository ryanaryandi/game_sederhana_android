...
public class kecoa extends AppCompatActivity {
    ImageView gambar;
    Button cek,imah;
    EditText jawab;
    String jawaban;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kecoa);
...
//mengambil gambar dari database
        Glide.with(kecoa.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fkecoa.jpg?alt=media&token=bd4f00cd-4038-4942-8d0d-15722fc1072a")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("kecoa")) {
                    ...
                    Intent pindah = new Intent(kecoa.this, tupai.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(kecoa.this, depan.class);
