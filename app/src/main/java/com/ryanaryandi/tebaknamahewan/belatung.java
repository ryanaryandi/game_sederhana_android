...
public class belatung extends AppCompatActivity {
    ImageView gambar;
    Button cek,imah;
    EditText jawab;
    String jawaban;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_belatung);
...
//mengambil gambar dari database
        Glide.with(belatung.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fbelatung.jpg?alt=media&token=831e9523-ac39-42a8-bfb1-414b3cdd1e59")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("belatung")) {
                    ...
                    Intent pindah = new Intent(belatung.this, tawon.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(belatung.this, depan.class);
