...
public class anjing extends AppCompatActivity {
    ImageView gambar;
    Button cek, imah;
    EditText jawab;
    String jawaban;
...
//mengambil gambar dari database
        Glide.with(anjing.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fanjing.jpg?alt=media&token=5530ebb3-78fd-4758-85e4-659fe1abdffc")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("anjing")) {
                    ...
                    Intent pindah = new Intent(anjing.this, labalaba.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(anjing.this, depan.class);
