...
public class kurakura extends AppCompatActivity {
    ImageView gambar;
    Button cek,imah;
    EditText jawab;
    String jawaban;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kurakura);
...
//mengambil gambar dari database
        Glide.with(kurakura.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fkura%20kura.jpg?alt=media&token=aedf8223-96cf-43b5-ac16-4592b9630783")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("kura kura")) {
                    ...
                    Intent pindah = new Intent(kurakura.this, badak.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(kurakura.this, depan.class);
