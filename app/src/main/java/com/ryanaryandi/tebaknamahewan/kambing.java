...
//mengambil gambar dari database
        Glide.with(kambing.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fkambing.jpg?alt=media&token=b9b5bbb6-80ce-4690-bee5-381bbdc139ca")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("kambing")) {
                    ...
                    Intent pindah = new Intent(kambing.this, bebek.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(kambing.this, depan.class);
