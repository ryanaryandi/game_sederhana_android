...
public class semut extends AppCompatActivity {
    ImageView gambar;
    Button cek,imah;
    EditText jawab;
    String jawaban;
...
//mengambil gambar dari database
        Glide.with(semut.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fsemut.jpg?alt=media&token=f65fc95b-f6a3-4d6d-a75b-bf793de05d43")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("semut")) {
                    ...
                    Intent pindah = new Intent(semut.this, nyamuk.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(semut.this, depan.class);
