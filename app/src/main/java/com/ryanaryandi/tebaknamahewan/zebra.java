...
//mengambil gambar dari database
        Glide.with(zebra.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fzebra.jpg?alt=media&token=d81c4214-2818-4ad5-a660-b5dd43e2d51e")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("zebra")) {
                    ...
                    Intent pindah = new Intent(zebra.this, monyet.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(zebra.this, depan.class);
