...
public class tikus extends AppCompatActivity {
    ImageView gambar;
    Button cek,imah;
    EditText jawab;
    String jawaban;
...
//mengambil gambar dari database
        Glide.with(tikus.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Ftikus.jpg?alt=media&token=c518b3da-446c-4eee-8e69-fa3e74b579e0")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("tikus")) {
                    ...
                    Intent pindah = new Intent(tikus.this, sapi.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(tikus.this, depan.class);
