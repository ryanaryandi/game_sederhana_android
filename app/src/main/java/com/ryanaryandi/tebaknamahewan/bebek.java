...
//mengambil gambar dari database
        Glide.with(bebek.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fbebek.jpg?alt=media&token=2f560903-e4d8-4462-bf6a-7251d96ae478")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("bebek")) {
                    ...
                    Intent pindah = new Intent(bebek.this, jerapah.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(bebek.this, depan.class);
