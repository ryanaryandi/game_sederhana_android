...
//mengambil gambar dari database
        Glide.with(udang.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fudang.jpg?alt=media&token=a04601ca-4b32-4188-ad63-d04f40c35be5")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("udang")) {
                    ...
                    Intent pindah = new Intent(udang.this, rusa.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(udang.this, depan.class);
