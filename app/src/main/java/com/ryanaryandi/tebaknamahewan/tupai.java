...
public class tupai extends AppCompatActivity {
    ImageView gambar;
    Button cek,imah;
    EditText jawab;
    String jawaban;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tupai);
...
//mengambil gambar dari database
        Glide.with(tupai.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Ftupai.jpg?alt=media&token=cdeb3a6b-1541-4f8a-a8d7-16664f1155a6")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("tupai")) {
                    ...
                    Intent pindah = new Intent(tupai.this, kelinci.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(tupai.this, depan.class);
