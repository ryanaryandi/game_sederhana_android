...
public class cendrawasih extends AppCompatActivity {
    ImageView gambar;
    Button cek,imah;
    EditText jawab;
    String jawaban;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cendrawasih);
...
//mengambil gambar dari database
        Glide.with(cendrawasih.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fcendrawasih.jpg?alt=media&token=99c3a735-3491-40df-aa5e-12fadc792673")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("cendrawasih")) {
                    ...
                    Intent pindah = new Intent(cendrawasih.this, gagal.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(cendrawasih.this, depan.class);
