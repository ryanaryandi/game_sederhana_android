...
public class kudanil extends AppCompatActivity {
    ImageView gambar;
    Button cek,imah;
    EditText jawab;
    String jawaban;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kudanil);
...
//mengambil gambar dari database
        Glide.with(kudanil.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fkudanill.jpg?alt=media&token=17663e9d-442b-4da6-9c9a-24ca0cac0ffe")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("kudanil")) {
                    ...
                    Intent pindah = new Intent(kudanil.this, babi.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(kudanil.this, depan.class);
