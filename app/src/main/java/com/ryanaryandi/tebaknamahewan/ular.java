...
//mengambil gambar dari database
        Glide.with(ular.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fular.jpg?alt=media&token=d04f2bb3-c25a-4a7b-be58-67744457d3c0")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("ular")) {
                    ...
                    Intent pindah = new Intent(ular.this, ulat.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(ular.this, depan.class);
