...
public class soang extends AppCompatActivity {
    ImageView gambar;
    Button cek,imah;
    EditText jawab;
    String jawaban;
    ...
    MediaPlayer aujam, aubenar, ausalah, auberhenti;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soang);
...
//mengambil gambar dari database
        Glide.with(soang.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fsoang.jpg?alt=media&token=89814b25-a0a3-4fcb-832e-b1751c79c54a")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("angsa")) {
                    ...
                    Intent pindah = new Intent(soang.this, ayam.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(soang.this, depan.class);
