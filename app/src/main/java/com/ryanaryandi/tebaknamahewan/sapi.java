...
//mengambil gambar dari database
        Glide.with(sapi.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fsapi.jpg?alt=media&token=13dc935c-dfbf-4a38-9a81-7957a7f7f36b")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("sapi")) {
                    ...
                    Intent pindah = new Intent(sapi.this, kambing.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(sapi.this, depan.class);
