...
public class kupukupu extends AppCompatActivity {
    ImageView gambar;
    Button cek,imah;
    EditText jawab;
    String jawaban;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kupukupu);
...
//mengambil gambar dari database
        Glide.with(kupukupu.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fkupu%20kupu.jpg?alt=media&token=cef2ed62-3e3d-4475-b983-99afae2ef93d")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("kupu kupu")) {
                    ...
                    Intent pindah = new Intent(kupukupu.this, singa.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(kupukupu.this, depan.class);
