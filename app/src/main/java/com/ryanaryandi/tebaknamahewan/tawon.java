...
public class tawon extends AppCompatActivity {
    ImageView gambar;
    Button cek,imah;
    EditText jawab;
    String jawaban;
...
//mengambil gambar dari database
        Glide.with(tawon.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Flebah.jpg?alt=media&token=60019af2-4a79-41ca-8e96-204a9dc10cd6")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("lebah")) {
                    ...
                    Intent pindah = new Intent(tawon.this, cendrawasih.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(tawon.this, depan.class);
