...
//mengambil gambar dari database
        Glide.with(dua.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fcat.jpg?alt=media&token=788b1de5-935b-4018-b162-4d5af380adc1")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("kucing")) {
                    ...
                    Intent pindah = new Intent(dua.this, soang.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(dua.this, depan.class);
