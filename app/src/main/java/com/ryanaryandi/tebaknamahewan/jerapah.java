...
public class jerapah extends AppCompatActivity {
    ImageView gambar;
    Button cek,imah;
    EditText jawab;
    String jawaban;
...
//mengambil gambar dari database
        Glide.with(jerapah.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fjerapah.jpg?alt=media&token=b693f338-2baa-406a-93df-7211363cb128")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("jerapah")) {
                    ...
                    Intent pindah = new Intent(jerapah.this, merpati.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(jerapah.this, depan.class);
