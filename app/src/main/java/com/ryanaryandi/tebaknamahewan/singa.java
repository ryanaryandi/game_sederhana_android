...
//mengambil gambar dari database
        Glide.with(singa.this).load("https://firebasestorage.googleapis.com/v0/b/tebak-nama-hewan-6069a.appspot.com/o/gambar%2Fsinga.jpg?alt=media&token=5ba1a355-d150-4bbf-aa02-2ade6a62b714")
                .into(gambar);
...
//membuat aksi pada jawaban
        cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jawaban.equals("singa")) {
                    ...
                    Intent pindah = new Intent(singa.this, beruang.class);
        ...
        imah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lanjut = new Intent(singa.this, depan.class);
